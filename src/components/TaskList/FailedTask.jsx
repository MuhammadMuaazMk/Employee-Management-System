...
const FailedTask = ({data}) => {
  return (
    ...
    <div className="card h-full rounded-[50px] bg-gradient-to-r from-red-500 to-red-300 transition-all ease-in-out duration-500 transform-style-preserve-3d shadow-lg">
      ...
      <div className="content px-8 pt-24 transform translate-z-[26px]">
        ...
        <span className="block text-[#da5037] font-extrabold text-4xl font-playfair mt-2">
          {data.taskTitle}
        </span>
        ...
        <a
          href="#_"
          className="relative px-3 py-2  font-extralight text-white transition duration-300 bg-rose-600 rounded-md hover:bg-rose-500 ease"
        >
      ...
      <div className="logo absolute top-0 right-0 transform-style-preserve-3d">
        <span className="circleee w-[170px] absolute aspect-ratio-1 rounded-full top-2 right-2 box-shadow-lg transform translate-z-[20px] bg-amber-300/20 transition-all ease-in-out duration-500"></span>
        <span className="circleee w-[140px] absolute aspect-ratio-1 rounded-full top-2.5 right-2.5 box-shadow-md transform translate-z-[40px] bg-amber-300/20 transition-all ease-in-out duration-500 delay-500ms"></span>
        <span className="circleee w-[110px] absolute aspect-ratio-1 rounded-full top-4 right-4 box-shadow-md transform translate-z-[60px] bg-amber-300/20 transition-all ease-in-out duration-500 delay-1000ms"></span>
        <span className="circleee w-[80px] absolute aspect-ratio-1 rounded-full top-6 right-6 box-shadow-md transform translate-z-[80px] bg-amber-300/20 transition-all ease-in-out duration-500 delay-1500ms"></span>
        <span className="circleee w-[50px] absolute aspect-ratio-1 rounded-full top-8 right-8 box-shadow-md transform translate-z-[100px] bg-amber-300/20 transition-all ease-in-out duration-500 delay-2000ms">
          <svg
            xmlns="http://www.w3.org/2000/svg"
